      ...
      <nav class="bg-white border-b border-gray-100">
              ...
              <div class="ml-3 relative">
                <Dropdown align="right" width="48">
                  ...
                  <template #content>
                    ...
                    <DropdownLink :href="route('owner.logout')" method="post" as="button">
                      Log Out
                    </DropdownLink>
                  </template>
                </Dropdown>
        ...
        <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            ...
            <ResponsiveNavLink :href="route('owner.manufacturer.index')"
              :active="route().current('owner.manufacturer.*')">
              メーカー
            </ResponsiveNavLink>
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <ResponsiveNavLink :href="route('owner.logout')" method="post" as="button">
                Log Out
              </ResponsiveNavLink>
            </div>
          </div>
