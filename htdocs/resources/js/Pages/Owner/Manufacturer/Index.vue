            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-8 mx-auto">
                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                  <Link as="button" :href="route('owner.manufacturer.create')"
                    class="flex ml-auto tracking-widest text-white bg-gray-600 py-2 px-4 uppercase focus:outline-none text-xs hover:bg-gray-500 rounded-md font-semibold">
                  登録</Link>
                </div>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                          メーカー名</th>
                        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">画像
                        </th>
                        <th
                    ...
                    <tbody>
                      <tr v-for="(manufacturer, key) in manufacturers" :key="manufacturer.id">
                        ...
                        <td class="px-4 py-3 text-center">
                          <input type="checkbox" name="is_display"
                            @change="toggleDisplay(key, manufacturer.id, manufacturer.is_display)"
                            v-model="manufacturer.is_display">
                        </td>
                      </tr>
                    </tbody>
                  </table>
