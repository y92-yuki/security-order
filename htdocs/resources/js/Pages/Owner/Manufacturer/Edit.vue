              ...
              <section class="text-gray-600 body-font">
                <div class="container px-5 py-10 mx-auto">
                  <form @submit.prevent="submit" class="md:w-2/3 mx-auto">
                    ...
                    <div class="p-2 w-full">
                      <div>
                        <div for="picture" class="leading-7 text-sm text-gray-600">画像添付:{{ manufacturer.picture ? '有' : '無'
                        }}</div>
                    ...
                    <Link as="button" :href="route('owner.manufacturer.show', { manufacturer: manufacturer.id })"
