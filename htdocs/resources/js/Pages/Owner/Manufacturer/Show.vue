              ...
              <section class="text-gray-600 body-font">
                <div class="container px-5 py-10 mx-auto">
                  ...
                  <div class="p-2 w-full">
                    ...
                    <textarea v-model="props.manufacturer.other" disabled id="other" name="other"
                  ...
                  <Link as="button" :href="route('owner.manufacturer.edit', { manufacturer: manufacturer.id })"
                  ...
                  <Link as="button" :href="route('owner.manufacturer.index')"
