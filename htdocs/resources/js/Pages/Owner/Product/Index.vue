            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-8 mx-auto">
                <div class="text-right">
                  <input type="text" id="product_name" name="product_name" v-model="search"
                ...
                <div class="pl-4 my-4 lg:w-2/3 w-full mx-auto">
                  <Link as="button" :href="route('owner.product.create')"
                  ...
                  <table v-else class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                      <tr v-for="(product, key) in products" :key="product.id">
                        ...
                        <td class="px-4 py-3">{{ product.picture }}</td>
                        <td class="px-4 py-3 text-center">
                          <input type="checkbox" name="is_selling"
                            @change="toggleSelling(key, product.id, product.is_selling)" v-model="product.is_selling">
                        </td>
                      </tr>
                    </tbody>
                  </table>
