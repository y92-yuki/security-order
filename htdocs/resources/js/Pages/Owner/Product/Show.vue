              ...
              <section class="text-gray-600 body-font">
                <div class="container px-5 py-10 mx-auto">
                  ...
                  <div class="p-2 w-full">
                    ...
                    <textarea id="memo" name="memo" v-model="props.product.memo" disabled
                  ...
                  <Link as="button" :href="route('owner.product.edit', { id: product.id })"
                  ...
                  <Link as="button" :href="route('owner.product.index')"
